...
// Hook for fetching user participation via App Router
export const useParticipationViaApi = createDataHook({
  queryKey: ['participation'],
  endpoint: '/api/user/participation-v2',
  appRouter: true, // Use App Router endpoint
  staleTime: 5 * 60 * 1000, // 5 minutes
  errorMessage: 'Failed to load participation information',
