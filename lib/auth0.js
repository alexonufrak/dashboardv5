...
// Create a module to export with the management property
const auth0Client = {
  // Define a getter for the management property
  get management() {
    // This returns a Promise that resolves to the management client
    return (async () => {
      if (!managementClient) {
