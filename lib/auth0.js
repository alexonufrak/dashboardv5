...
export const auth0 = new Auth0Client({
  ...
  session: {
    ...
    // Leverage environment variables for cookie settings
    // Use AUTH0_COOKIE_SAME_SITE=none in .env.local to allow cross-origin requests
    cookie: {
      httpOnly: true,
      secure: true, // Essential for secure sessions across all request types
      // No sameSite value specified here, it will use the AUTH0_COOKIE_SAME_SITE env variable
