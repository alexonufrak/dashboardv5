import { getSession, withApiAuthRequired as originalWithApiAuthRequired } from "@auth0/nextjs-auth0";
import { ManagementClient } from "auth0";
import axios from 'axios';
import auth0Config from './auth0-config';

// Create a wrapped version of withApiAuthRequired that includes proper configuration
export const withApiAuthRequired = (handler) => {
  return originalWithApiAuthRequired((req, res) => {
    // Add configuration context to the request for debugging
