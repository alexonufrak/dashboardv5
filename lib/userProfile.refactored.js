    ...
    const completeProfile = {
      ...
      institution: {
        ...
        id: institutionData?.id || 
            (educationRecord?.institution && educationRecord.institution.length > 0 
              ? educationRecord.institution[0] : null) || 
      ...
      isProfileComplete: Boolean(
        ...
        (educationRecord?.degreeType || airtableProfile["Degree Type (from Education)"]?.[0]) &&
        (!isUMD || (programData?.Major || educationRecord?.majorName || airtableProfile["Major (from Education)"]?.[0])) &&
        (educationRecord?.graduationYear || airtableProfile["Graduation Year (from Education)"]?.[0]) &&
        ((institutionData?.Name || 
          educationRecord?.institutionName) && 
         (institutionData?.id || (educationRecord?.institution && educationRecord.institution.length > 0)))
      ),
