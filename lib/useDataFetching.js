...
export function useUpdateProfile() {
  ...
  return useMutation({
    ...
    mutationFn: async (updatedData) => {
      ...
      // Make the API request using standard cookie authentication
      const response = await fetch(`/api/user/profile`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "X-Transaction-ID": transactionId // Keep transaction ID for tracing
        },
        credentials: 'include', // Rely on browser sending session cookies
