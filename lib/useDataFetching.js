...
export function useUpdateProfile() {
  ...
  return useMutation({
    mutationFn: async (updatedData) => {
      // Create a transaction ID for this update
      ...
      // Process the major field properly
      ...
      // Create a specialized endpoint URL that includes auth info in the query string
      ...
      // Make the API request with auth info in both query and headers
      ...
      if (!profileData || typeof profileData !== 'object') {
        console.warn('Received unexpected profile data format:', profileData);
    ...
    // After mutation finishes (success or failure)
    onSettled: () => {
