...
export async function getCohortsByInstitution(institutionId) {
  try {
    if (!partnershipsTable || !cohortsTable || !initiativesTable) {
    ...
    // Step 4: Fetch all initiatives in one batch
    ...
    // Step 5: Enhance cohorts with initiative details
    ...
    console.log(`Found ${enhancedCohorts.length} open cohorts with initiative details`);
