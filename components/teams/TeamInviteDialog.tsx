...
const TeamInviteDialog = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast({
        title: "Success",
        description: `Invitation sent to ${firstName} ${lastName}. An invitation to join ${team?.name || "your team"} has been sent to ${email}.`,
        color: "success"
      })
            ...
            <ModalBody>
              ...
              {isVerified && isValidDomain && (
                <Alert 
                  ...
                  description={`Email verified from ${institutionInfo?.institution || "valid institution"}`}
                />
              )}
