    ...
    <>
      ...
      <SidebarProvider defaultOpen>
        <div className="flex min-h-screen h-screen">
          ...
          <div className="md:hidden fixed top-0 left-0 right-0 z-30 bg-white dark:bg-neutral-900 border-b dark:border-neutral-800 py-3 px-4 flex justify-between items-center shadow-xs">
