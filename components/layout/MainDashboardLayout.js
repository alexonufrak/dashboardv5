      ...
      {renderWithSidebar ? (
        ...
        >
          ...
          {(() => {
            ...
            return (
              <>
                {/* Main area with sidebar - positioned below the header */}
                <SidebarProvider open={sidebarOpen} onOpenChange={setSidebarOpen}>
                  {/* Header - positioned outside of the sidebar, spans full width */}
                  <header className="sticky top-0 z-50 flex h-[3.5rem] w-full items-center border-b bg-background">
                  ...
                  {/* Sidebar component positioned below the header */}
                  <AppSidebar className="top-[3.5rem] h-[calc(100svh-3.5rem)]" pageTitle={title} />
                  
                  {/* Main content area */}
                  <SidebarInset className="bg-background mt-[3.5rem]">
