            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Chip 
                    size="sm" 
                    color={programData?.isTeamBased ? 'primary' : 'success'}
                    variant="flat"
                  >
                    {programData?.isTeamBased ? 'Team-Based' : 'Individual'}
                  </Chip>
              ...
              <div className="flex flex-col md:items-end gap-2">
                ...
                {programData?.isTeamBased && teamData && (
                  <div className="flex items-center gap-2">
              ...
              <Card>
                <CardHeader>
                  <h2 className="text-xl font-bold">
                    {programData?.isTeamBased ? "Team Members" : "Your Progress"}
                  </h2>
                </CardHeader>
                <CardBody>
                  {programData?.isTeamBased && teamData ? (
