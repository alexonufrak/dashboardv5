...
export function CompassIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function CommandIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function AwardIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function TeamIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function MilestoneIcon({ className = "w-5 h-5", size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
